  ...
  return (
    <div className="bg-white dark:bg-[#161618] rounded-xl border border-stone-200 dark:border-white/[0.10] p-4">
      <div className="flex flex-wrap items-center gap-6 text-sm">
        <div>
          <span className="text-[11px] text-stone-500 dark:text-stone-400 block">Period</span>
        ...
        <div>
          <span className="text-[11px] text-stone-500 dark:text-stone-400 block">Days in month</span>
          <span className="font-medium text-stone-900 dark:text-stone-100">{daysInMonth} days, {workingDaysMTD} workdays</span>
        </div>
        <div className="h-8 w-px bg-stone-200 dark:bg-white/[0.08]" />
        <div>
          <span className="text-[11px] text-stone-500 dark:text-stone-400 block">Target Load</span>
          <span className="font-medium text-stone-900 dark:text-stone-100">85%</span>
        </div>
        <div className="h-8 w-px bg-stone-200 dark:bg-white/[0.08]" />
        <div>
          <span className="text-[11px] text-stone-500 dark:text-stone-400 block">FTE</span>
          <span className="font-medium text-stone-900 dark:text-stone-100">{fteCount}</span>
        </div>
        <div className="h-8 w-px bg-stone-200 dark:bg-white/[0.08]" />
        <div>
          <span className="text-[11px] text-stone-500 dark:text-stone-400 block">Working days YTD</span>
